...
def process_single_folder(folder, input_folder, output_folder):
    ...
    read_full_folder(_input_folder, _output_folder, random_state=1310, k=20)
...
if __name__ == "__main__":
    ...
    output_folder = "E:/palm/data-collection/sub_dataset/script2"
